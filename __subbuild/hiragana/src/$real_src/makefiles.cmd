...
title hitakana - Command line [hiragana] (compile from source)
...
echo.
copy /b header.txt + debugcheck.txt + pingwait.txt + miscellchars.txt + hiraganaindex.txt indexlister.bat
